...
- 4 edges to [[_COMMUNITY_SpeechListener  WakewordDetector  _whisper_device()]]
...
- 2 edges to [[_COMMUNITY_AppCtrl  .open_app()  ._find_shortcut()]]
- 2 edges to [[_COMMUNITY_BrowserCtrl  browser_ctrl.py  .open_url()]]
- 2 edges to [[_COMMUNITY_ComputerControl  ._na()  .click_text()]]
...
- 2 edges to [[_COMMUNITY_ScreenshotSearch  screenshot_search.py  _capture_screen()]]
...
- 2 edges to [[_COMMUNITY_ClipboardSync  .start()  clipboard_sync.py]]
- 2 edges to [[_COMMUNITY_AutoAgent  ._plan()  ._execute_task()]]
...
## Top bridge nodes
- [[._init_all()]] - degree 62, connects to 57 communities
- [[LokiApplication]] - degree 70, connects to 55 communities
