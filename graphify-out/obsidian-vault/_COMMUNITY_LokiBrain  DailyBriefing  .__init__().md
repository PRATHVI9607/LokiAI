...
# LokiBrain / DailyBriefing / .__init__()
...
```dataview
TABLE source_file, type FROM #community/LokiBrain_/_DailyBriefing_/___init__
SORT file.name ASC
```
...
- 2 edges to [[_COMMUNITY_._init_all()  AppCtrl  DailyBriefing]]
...
- 1 edge to [[_COMMUNITY_FakeTTS  ConvState  conversation_sm.py]]
...
## Top bridge nodes
- [[LokiBrain]] - degree 64, connects to 32 communities