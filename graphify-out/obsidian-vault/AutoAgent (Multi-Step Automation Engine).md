...
# AutoAgent (Multi-Step Automation Engine)

## Connections
- [[ActionRouter_1]] - `calls` [EXTRACTED]
- [[AutoAgent.SAFE_INTENTS]] - `references` [EXTRACTED]
- [[AutoAgent._execute_task]] - `implements` [EXTRACTED]
- [[AutoAgent._plan (LLM step planner)]] - `implements` [EXTRACTED]
- [[AutoAgent.run]] - `implements` [EXTRACTED]
