...
# ._init_all() / AppCtrl / DailyBriefing
...
```dataview
TABLE source_file, type FROM #community/_init_all_/_AppCtrl_/_DailyBriefing
SORT file.name ASC
```

## Connections to other communities
- 4 edges to [[_COMMUNITY_LokiApplication  .__init__()  main.py]]
- 2 edges to [[_COMMUNITY_LokiBrain  DailyBriefing  .__init__()]]
...
- 1 edge to [[_COMMUNITY_TestVoicePipeline  ProcessManager  TestProcessManagerExactMatch]]
...
- [[AppCtrl]] - degree 6, connects to 1 community