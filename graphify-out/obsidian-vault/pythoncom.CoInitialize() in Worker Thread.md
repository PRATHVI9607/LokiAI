...
# pythoncom.CoInitialize() in Worker Thread

## Connections
- [[COM Thread Requirement Fix (pyttsx3 Windows)]] - `implements` [EXTRACTED]
- [[_queue_worker (TTS Serialization Thread)]] - `references` [EXTRACTED]
