...
# _queue_worker (TTS Serialization Thread)

## Connections
- [[COM Thread Requirement Fix (pyttsx3 Windows)]] - `rationale_for` [INFERRED]
- [[LokiTTS_1]] - `implements` [EXTRACTED]
- [[pythoncom.CoInitialize() in Worker Thread]] - `references` [EXTRACTED]
