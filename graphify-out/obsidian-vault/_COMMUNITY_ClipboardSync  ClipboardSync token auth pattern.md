...
# ClipboardSync / ClipboardSync token auth pattern
...
```dataview
TABLE source_file, type FROM #community/ClipboardSync_/_ClipboardSync_token_auth_pattern
SORT file.name ASC
```
...
## Top bridge nodes
- [[ClipboardSync_1]] - degree 4, connects to 1 community