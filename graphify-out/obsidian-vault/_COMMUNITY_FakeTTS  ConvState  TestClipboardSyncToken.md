...
# FakeTTS / ConvState / TestClipboardSyncToken
...
```dataview
TABLE source_file, type FROM #community/FakeTTS_/_ConvState_/_TestClipboardSyncToken
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_LokiTTS  ._queue_worker()  ._speak_edge()]]
- 5 edges to [[_COMMUNITY_PendingActionStore  TestPendingActions  .is_expired()]]
- 5 edges to [[_COMMUNITY_ProcessManager  TestProcessManagerExactMatch  process_manager.py]]
...
- 4 edges to [[_COMMUNITY_ActionRouter  ._handle_agent_cancel()  ._handle_agent_status()]]
- 4 edges to [[_COMMUNITY_ConversationStateMachine  ._arm_timeout()  ._cancel_timeout()]]
