...
# renderMarkdown (block-level: fenced code, lists, paragraphs)

## Connections
- [[MessageBubble Component]] - `calls` [EXTRACTED]
- [[inlineRender (lightweight inline markdown, no external dep)]] - `calls` [EXTRACTED]
- [[useMemo Caching for renderMarkdown]] - `references` [EXTRACTED]
