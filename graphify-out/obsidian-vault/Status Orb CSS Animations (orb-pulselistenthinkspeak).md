...
# Status Orb CSS Animations (orb-pulse/listen/think/speak)

## Connections
- [[StatusOrb (Status Indicator Pill)]] - `conceptually_related_to` [INFERRED]
- [[Tailwind Config (Loki Design Tokens)]] - `references` [EXTRACTED]
