---
source_file: "loki-ui/tailwind.config.ts"
type: "code"
...
# Tailwind Config (Loki Design Tokens)

## Connections
- [[Loki Design Color Palette]] - `references` [EXTRACTED]
- [[PostCSS Config]] - `conceptually_related_to` [INFERRED]
- [[Status Orb CSS Animations (orb-pulselistenthinkspeak)]] - `references` [EXTRACTED]
