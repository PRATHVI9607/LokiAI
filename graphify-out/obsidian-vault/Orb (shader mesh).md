...
## Connections
- [[Custom GLSL Shader (simplex noise + fresnel)]] - `implements` [EXTRACTED]
- [[PlasmaOrb_1]] - `references` [EXTRACTED]
- [[STATE_PARAMS (voice-state â†’ shader uniforms)]] - `references` [EXTRACTED]
