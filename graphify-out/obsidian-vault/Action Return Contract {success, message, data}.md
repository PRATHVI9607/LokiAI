...
# Action Return Contract {success, message, data}

## Connections
- [[Action Return Format Contract]] - `semantically_similar_to` [EXTRACTED]
- [[Rationale message field always safe to speak aloud (secrets only in data field)]] - `rationale_for` [EXTRACTED]
